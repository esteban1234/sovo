...
<body>
  ...
  <div class="fondo">
    <div class="container cont-menu" style="margin-top: 2%;">
     <div class="col-md-3" >
        <a class="btn btn-block btn-lg btn-success delete-br" href="../index.php" >
            <i class="fa fa-bars oculto-i" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> INDEX</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-danger delete-br" href="nosotros.php">
            <i class="fa fa-users oculto-i" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> NOSOTROS</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-primary delete-br" href="servicios.php">
            <i class="fa fa-cog oculto-i" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> SERVICIOS</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-warning delete-br" href="contacto.php"  id="select">
            <i class="fa fa-phone oculto-i" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> CONTACTO</span></a>
      </div> 
    </div>

    <p class="acbm">EN SOVO TRANSPORTADORA Y LOGISTICA SA DE CV <br>QUEREMOS CONTRIBUIR AL EXITO DE TU EMPRESA</p>
    <figure class="logo">
    ...
    <div class="row row-format">
        <form role="form" id="contact-form" class="contact-form" onSubmit="return false">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" autocomplete="off" id="txtCORREO" placeholder="Escribe tu correo completo">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" class="form-control" name="email" autocomplete="off" id="txtTELEFONO" placeholder="Escribe tu número teléfonico">
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    ...
                    <div id="_AJAX_PRE_" class="col-sm-12  col-md-12 col-lg-12"></div>
                    <div class="row">
                    <div class="col-md-12">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-5 col-md-4">
            <h2 class="tit-de">Datos Empresa</h2>
            <address>
