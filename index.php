...
<div class="banneri">
  <div class="fondo">
    <div class="container" style="margin-top: 2%;">
     <div class="col-md-3" >
        <a class="btn btn-block btn-lg btn-success" href="index.php" id="select" >
            <i class="fa fa-bars" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> INDEX</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-danger" href="vistas/nosotros.php">
            <i class="fa fa-users" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> NOSOTROS</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-primary" href="vistas/servicios.php">
            <i class="fa fa-cog" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> SERVICIOS</span></a>
      </div>
      <div class="col-md-3">
        <a class="btn btn-block btn-lg btn-warning" href="vistas/contacto.php">
            <i class="fa fa-phone" id="icone_grande"></i> <br><br>
            <span class="texto_grande"> CONTACTO</span></a>
      </div> 
    </div>

    <p>ASEGURAMOS TU CARGA CON LA TASA MAS BAJA DEL MERCADO <br> ¡GARANTIZADO!</p>
    <figure class="logo">
    ...
    <hr class="linea"> <br><br>
      <div class="row">
        <div class="div1">
          ...
          <p class="texto" style="background-color: #333; color: #fff;height:200px;">¡Aseguramos tu carga por menos del 1%! <br><br>
